...
class AboutRegularExpressions < Neo::Koan
  ...
  # still allowing the overall match to succeed.
  ...
  # Extra:
  # A quantifier followed by + matches possessively: once it has matched it does not
  # backtrack. They behave like greedy quantifiers, but having matched they refuse to
  # “give up” their match even if this jeopardises the overall match.
  # ------------------------------------------------------------------
